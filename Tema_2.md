...
Данный код, состоящий из одной строки `print("Hello World".count("o"))`, находит в строке "Hello World" символ "o" и выводит на экран количество совпалений по поиску. За поиск и нахождение количества совпадений отвечает функция `count()`, свойственная строковым переменным (и не только им, но и спискам, кортежам, и т.д.).
